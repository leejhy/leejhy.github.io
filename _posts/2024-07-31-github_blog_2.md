...
## _config.yml
위 사진처럼 생긴 파일인데 주석에 설명이 잘 돼있어서 주석만 보고도 설정 할 수 있을것 같지만 감이 잘 안잡힌다   
변경 해줘야할 부분을 먼저 간단하게 적어보자면,
...
![](/assets/img/github/2_title.png){: width="300px"}*title*
## 적용 부분
이 사진에서 Leejhy라고 적혀있는 부분이 `title`, 개발 공부정리 라고 적혀있는 부분이 `tagline`이다.   
